...
select
    ...
    pg_stat_all_tables.last_autovacuum,pg_stat_all_tables.last_vacuum,
    pg_stat_all_tables.last_autoanalyze,pg_stat_all_tables.last_analyze,
...
where
    pg_namespace.nspname not in ('pg_toast','pg_catalog','sys','information_schema')
order by
    5 desc
;
